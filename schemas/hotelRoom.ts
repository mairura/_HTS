...
const hotelRoom = {
  ...
  fields: [
    ...
    defineField({
      ...
      type: "text",
      validation: (Rule) =>
        Rule.required().min(100).error("Min 100 characters"),
    }),
    defineField({
      name: "price",
      title: "Price",
    ...
    defineField({
      ...
      validation: (Rule) => Rule.required(),
      initialValue:
        "Check-in time: 12:00 PM, Check-out time: 11:59 AM. If you leave behind any items, please contact the receptionist.",
    }),
    defineField({
      name: "dimension",
      title: "Dimension",
