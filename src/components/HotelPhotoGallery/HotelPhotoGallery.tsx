...
const HotelPhotoGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  const remainingPhotoCOunt = totalPhotos - maximumVisiblePhotos;
          ...
          {remainingPhotoCOunt > 0 && (
            ...
            >
              <Image
                ...
                height={150}
              />
              <div className="absolute cursor-pointer inset-0 bg-[rgba(0,0,0,0.5)] bg-opacity-50 flex justify-center items-center">
